...
export default function ChatWidget() {
  ...
  async function submit(event: FormEvent) {
    ...
    try {
      ...
      setMessages([...nextMessages, { role: "assistant", content: "I couldn't reach the assistant service right now. Dhrubo is available at dhrubojyoti.gangopadhyay@gmail.com or WhatsApp +91 82408 01921." }]);
    } finally {
      setLoading(false);
    }
  }
